            ...
            <div class="container mt-5">
                <div class="row mx-5">
                    ...
                    <div class="col-12 border border-dark rounded bg-light mt-4">
                        ...
                        <div class="row mx-4 d-flex justify-content-evenly mt-4 pb-4">
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <input type="text" class="form-control form-control-sm" value="<?= $_SESSION['user']['direccion'] ?>" style="max-width: 300px;"> 
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="col-12 border-end border-start border-bottom border-dark rounded bg-light px-md-5">
                        ...
                        <p class="text-end">
                            <button class="btn btn-dark mt-2">MODIFICAR PEDIDO</button>
                        </p>
                            ...
                            <div class="col-lg-6 pt-3 pb-2 px-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <input type="text" class="form-control form-control-sm ms-2" placeholder="2000" style="max-width: 300px;">                               
                                    </div>
                                    <div class="col-md-6">
